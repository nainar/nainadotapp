...
const Footer = () => (
    ...
    `}</style>
    <a href="https://github.com/nainar" target="_blank" rel="noopener" aria-label="Look at my GitHub">
    ...
    <a href="https://twitter.com/nainar92" target="_blank" rel="noopener" aria-label="Follow me on Twitter">
      <svg viewBox="0 0 18 18" style={svgStyle}>
          <g>
    ...
    <a href="https://www.instagram.com/nainar92/" target="_blank" rel="noopener" aria-label="Follow me on Instagram">
